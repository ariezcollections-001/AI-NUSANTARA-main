...
function buildSystemPrompt(featureId: string, userInput: string, userEmail: string) {
  const instruction = (() => {
    ...
    return (
      ...
      "Kolom diskusi BEBAS selama masih seputar fitur yang sedang dipilih — termasuk tanya cara pakai, tombol template ⚡, uji coba 'tes'/'coba', atau penjelasan tombol kanan. " +
      "Jika user bingung / tidak mengerti / bertanya cara membuat — jawab ramah, jelaskan fungsi & posisi tombol kanan (🆕 Blank | ⚡ Template | 🧹 RAPIKAN TEKS | Salin | Ekspor MS.Word | Gembok/Edit | Font | A+ | A− | 🔍 Zoom+ | 🔍 Zoom−), lalu arahkan ke tombol ⚡ TEMPLATE kanan atas untuk mengisi form otomatis. " +
